        ...
        <div class="mail closed" id="mail">
            ...
            <div class="letter">
                ...
                <div class="letter-signature">
                    <span class="typewriter">Always Yours</span>
                </div>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            mail.addEventListener('click', function() {
                if (!isOpen) {
                    ...
                    // Create opening sound effect
                    const paperSound = new Audio('data:audio/wav;base64,UklGRigAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YQQ');
                    paperSound.volume = 0.3;
                    paperSound.play().catch(e => console.log('Sound effect error:', e));
                } else {
            ...
            // Add paper rustle sound on hover
            mail.addEventListener('mouseenter', function() {
                if (!isOpen) {
                    const rustleSound = new Audio('data:audio/wav;base64,UklGRigAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YQQ');
                    rustleSound.volume = 0.1;
                    rustleSound.play().catch(e => console.log('Sound effect error:', e));
                }
            });
        });
    </script>
